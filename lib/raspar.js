 ...
 * @param {Boolean} [options.ttl] TTL (Time to live) in seconds for local/memory based cache. Default: 1800
...
const requestFromUrl = (url, options) => {
    ...
    return request(Object.assign({url}, settings.requestOptions))
        .then(res => {

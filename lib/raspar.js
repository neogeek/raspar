 ...
 *
 * @example raspar.requestFromUrl('http://www.google.com/humans.txt').then(() => {});
 ...
 *
 * @example raspar.formatCache({}).then(function (res) { console.log(res.cached); });
 ...
 *
 * @example raspar.requestFromCache('http://www.google.com/humans.txt').then(() => {});
 * @param {String} url A URL string.
 * @param {Object} [options] Options object.
 * @param {Boolean} [options.ttl] TTL (Time to live) for local/memory based cache.
 * @param {Boolean} [options.cacheDirectory] Directory to store cache. Defaults to `temp/cache/`.
 ...
 *
 * @example raspar.requestFromUrlorCache('http://www.google.com/humans.txt').then(() => {});
 * @param {String} url A URL string.
 * @param {Object} [options] Options object.
 * @param {Boolean} [options.ttl] TTL (Time to live) for local/memory based cache.
 * @param {Boolean} [options.cacheDirectory] Directory to store cache. Defaults to `temp/cache/`.
 ...
 *
 * @example raspar.get('http://www.google.com/humans.txt').then(() => {});
 * @example raspar.get(['http://www.google.com/humans.txt']).then(() => {});
